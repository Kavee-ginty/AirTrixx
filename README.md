...
- a built-in `3dviewer.net` mapping profile for Online 3D Viewer: left fist + right-hand movement orbits, right fist pans, right index finger points/selects, and pointing-depth or wrist pitch zooms (see [docs/3d_viewer.md](docs/3d_viewer.md))
